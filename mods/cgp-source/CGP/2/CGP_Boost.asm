...
;4; Fire Stingray
boost_drain:
    dw 0022, 0021, 0023, 0020        ;table for health drain while boosting. 1: BF, 2: WG, 3: GF, 4:FS

duration_table:
    db 150, 150, 150, 150                ;table for s-jet duration. 1: BF, 2: WG, 3: GF, 4:FS
...
sub_routine_one:
  ...
  PHX
  PHY
;check whether we are even racing  
  LDA $0054                        
  CMP #$02
  BNE b_
  LDA $0055
...
;check whether we are at least lap 2, boost is still active, and have enough health
sub_routine_three:
  LDA $0F53
  BEQ c_
  ;LDA #$08
...
; stop drain if race is finished    
  LDA #$05                                        ;#$5 is the lap counter after race is finished
  CMP $0D40                            ;lap counter
  BEQ End_Drain_Routine                        ;branch if it was 5
